...
export const manifest: ModuleManifest = {
  ...
  translations: {
    ...
    fa: {
      'modules.pipelines.description': 'اتوماسیون‌های ساخت‌وساز را به‌صورت بصری بسازید: محرک‌ها، منابع داده، تبدیل‌ها، دروازه‌های اعتبارسنجی و خروجی‌ها، به شکل یک گراف گره‌ای.',
    },
    he: {
