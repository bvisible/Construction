...
export const manifest: ModuleManifest = {
  ...
  translations: {
    ...
    fa: {
      'modules.methodology_desc': 'برآورد داده‌محور: یک زنجیره ضرایب بالاسری را نصب یا خودتان بسازید (تفکیک عملیات اجرایی و ماشین‌آلات، مبالغ پایه، پله‌های درصدی پیاپی و مالیات بر ارزش افزوده)، همراه با ابعاد تحلیلی و منابع تأمین مالی.',
      'methodology.editor_title': 'ویرایشگر روش‌شناسی',
    },
    he: {
