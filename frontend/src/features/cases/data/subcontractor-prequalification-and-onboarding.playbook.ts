  ...
  steps: [
    {
      id: 'submit',
      icon: 'FileCheck',
      titleKey: 'cases.subcontractor_prequalification_and_onboarding.step.submit.title',
      titleDefault: 'Submit your qualification documents',
      whatKey: 'cases.subcontractor_prequalification_and_onboarding.step.submit.what',
      whatDefault:
      ...
      whyKey: 'cases.subcontractor_prequalification_and_onboarding.step.submit.why',
      whyDefault:
    ...
    },
    {
      id: 'safety',
      icon: 'ShieldAlert',
      titleKey: 'cases.subcontractor_prequalification_and_onboarding.step.safety.title',
      titleDefault: 'Attach your safety record',
      whatKey: 'cases.subcontractor_prequalification_and_onboarding.step.safety.what',
      whatDefault:
      ...
      whyKey: 'cases.subcontractor_prequalification_and_onboarding.step.safety.why',
      whyDefault:
    ...
    },
    {
      id: 'approved',
      icon: 'PackageCheck',
      titleKey: 'cases.subcontractor_prequalification_and_onboarding.step.approved.title',
      titleDefault: 'Get approved and stay on the list',
      whatKey: 'cases.subcontractor_prequalification_and_onboarding.step.approved.what',
      whatDefault:
      ...
      whyKey: 'cases.subcontractor_prequalification_and_onboarding.step.approved.why',
      whyDefault:
