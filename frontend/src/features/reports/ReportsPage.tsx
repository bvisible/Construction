...
async function downloadProgressReport(projectId: string, projectName: string): Promise<void> {
  ...
  htmlParts.push(`<p class="footer">Report generated by Neoconstruction on ${new Date().toLocaleString()}</p>`);
        ...
        <CustomReportBuilder
          ...
          onGenerate={async () => {
            ...
            try {
              ...
              htmlParts.push(`<p class="generated">Report generated by Neoconstruction on ${new Date().toLocaleString()}</p>`);
              htmlParts.push('</body></html>');
