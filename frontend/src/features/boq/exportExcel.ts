...
export function buildBOQSheet(options: ExportOptions): {
  ...
  rows.push([infoLine || 'Neoconstruction', ...Array(colCount - 1).fill(null)]);
  ...
  // ── Footer ────────────────────────────────────────────────────────────
  rows.push(Array(colCount).fill(null));
  rows.push([`Generated by Neoconstruction  |  ${dateStr}  |  openconstructionerp.com`, ...Array(colCount - 1).fill(null)]);
...
export function exportBOQToExcel(options: ExportOptions): void {
  ...
  wb.Props = {
    Author: 'Neoconstruction — DataDrivenConstruction',
