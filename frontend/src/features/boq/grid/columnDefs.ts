...
export function getColumnDefs(context: BOQColumnContext): ColDef[] {
  ...
  return [
    ...
    },
    {
      ...
      field: 'ordinal',
      //// NEOFFICE — notre width:124 fixe (20/08, plainte de Cédric sur
      //// les numéros tronqués) est ABANDONNÉ au profit de la solution
      //// upstream ci-dessous, qui est meilleure : elle calcule la largeur
      //// depuis la donnée réelle et la pose aussi en minWidth, sinon
      //// sizeColumnsToFit la reprend. Même problème, meilleure réponse.
