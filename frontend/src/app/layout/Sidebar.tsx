...
const navGroups: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      // This static entry guarantees discoverability of the module from
      // the sidebar regardless of registry state.
      // REVIEW: permanent (CH-specific). Other regional exchange modules
      // continue to be injected dynamically from the module registry.
