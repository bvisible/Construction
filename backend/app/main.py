...
async def _seed_demo_account() -> None:
    ...
    * manager@openconstructionerp.com     (role=manager)
    ...
    try:
        ...
        # //// NEOFFICE PATCH — opt out of the flagship "Residential House — Reference
        # Build" seed: Neoffice demo instances keep only Villa Bois-Mermet (Protti).
        # Set OE_SEED_FLAGSHIP=false in .env to keep it gone. See Obsidian note 06.
