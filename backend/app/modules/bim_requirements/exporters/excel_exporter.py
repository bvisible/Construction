...
def export_excel(
    ...
    try:
        # //// NEOFFICE PATCH — Public brand (AGPL attribution kept in keywords).
        wb.properties.creator = "Neoconstruction · Neoffice"
        wb.properties.lastModifiedBy = "Neoconstruction"
        wb.properties.description = (
            "Généré par Neoconstruction (https://neoffice.ch) — "
            "based on OpenConstructionERP by DataDrivenConstruction"
        )
        wb.properties.keywords = "Neoconstruction,Neoffice,BIM Requirements,based on OpenConstructionERP"
