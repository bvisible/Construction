...
TEMPLATE = DemoTemplate(
    ...
    project_description=(
        "Construção de torre comercial corporativa (edificio de escritorios "
        "classe AAA) em concreto armado, 22 pavimentos-tipo de lajes "
        "corporativas + terreo (lobby de pe-direito duplo) + 4 subsolos de "
        "garagem. Área de terreno ~3.400 m2, área construida total (ABC) "
        ...
        "6118) com nucleo rigido de circulação e lajes protendidas. Fachada "
        ...
        "e proteção contra incendio aprovados pelo Corpo de Bombeiros do Estado "
    ...
    boq_name="Orcamento Sintetico Corporativo - Padrão SINAPI",
    boq_description=(
        "Orcamento sintetico por etapas conforme pratica brasileira para "
        "edificio comercial corporativo, composições referenciadas ao SINAPI "
    ...
    sections=[
        ...
        (
            ...
            [
                ...
                ("01.002", "Tapume metálico galvanizado h=2,40m no perimetro (Site hoarding)", "m2", 980, 118.00, {"sinapi": "73604"}),
                ("01.003", "Canteiro de obra em containers metálicos modulares (Modular site offices)", "m2", 640, 680.00, {"sinapi": "73847/001"}),
                ("01.004", "Ligação provisoria de água e esgoto (Temporary water/sewer)", "vb", 1, 28000.00, {"sinapi": "98459"}),
                ("01.005", "Ligação provisoria de energia elétrica em media tensao (Temporary MV power)", "vb", 1, 68000.00, {"sinapi": "98460"}),
                ...
                ("01.011", "Plano de gerenciamento de residuos da construção civil PGRCC (Waste mgmt plan)", "vb", 1, 95000.00, {"nbr": "NBR 15112"}),
            ],
        ),
        ...
        (
            ...
            [
                ...
                ("02.008", "Instrumentação geotecnica e monitoramento (Geotechnical monitoring)", "vb", 1, 165000.00, {"nbr": "NBR 6122"}),
            ],
        ),
        ...
        (
            ...
            [
                ...
                ("03.009", "Impermeabilização de baldrame e blocos com manta asfaltica (Waterproofing)", "m2", 4200, 62.00, {"nbr": "NBR 9575"}),
        ...
        (
            ...
            [
                ...
                ("04.005", "Forma metálica reaproveitavel de pilar e nucleo (Steel column/core forms)", "m2", 18500, 128.00, {"sinapi": "92444"}),
        ...
        (
            ...
            [
                ...
                ("05.002", "Alvenaria de bloco ceramico 14x19x39cm áreas internas (Ceramic block wall)", "m2", 18500, 82.00, {"sinapi": "87489"}),
        ...
        (
            ...
            [
                ...
                ("06.009", "Corrimao metálico em escadas - NBR 9050 (Handrails)", "m", 1480, 175.00, {"nbr": "NBR 9050"}),
        ...
        (
            ...
            {"nbr": "NBR 9575"},
            [
                ("07.001", "Impermeabilização de laje de cobertura com manta asfaltica 4mm (Roof waterproofing)", "m2", 1850, 92.00, {"nbr": "NBR 9575"}),
                ...
                ("07.004", "Proteção mecanica de impermeabilização em argamassa (Screed protection)", "m2", 1850, 34.00, {"sinapi": "98557"}),
                ("07.005", "Telhado metálico termoacustico casa de maquinas (Metal roof plant room)", "m2", 980, 175.00, {"nbr": "NBR 8800"}),
        ...
        (
            ...
            [
                ...
                ("08.006", "Revestimento ceramico de parede áreas molhadas (Wall tiling)", "m2", 12500, 92.00, {"sinapi": "87263"}),
        ...
        (
            "09",
            "Instalações Hidrossanitárias e Incendio (Plumbing / fire) - NBR 5626",
            {"nbr": "NBR 5626"},
            [
                ("09.001", "Tubulação de água fria PVC/PPR soldavel (Cold water piping)", "m", 14500, 32.00, {"nbr": "NBR 5626"}),
                ("09.002", "Tubulação de água quente CPVC áreas tecnicas (Hot water piping)", "m", 3800, 46.00, {"nbr": "NBR 7198"}),
                ("09.003", "Tubulação de esgoto e ventilação PVC serie reforcada (Drainage/vent)", "m", 12800, 42.00, {"nbr": "NBR 8160"}),
                ("09.004", "Tubulação de águas pluviais PVC e ferro fundido (Rainwater piping)", "m", 4800, 58.00, {"nbr": "NBR 10844"}),
                ("09.005", "Louca sanitária suspensa com valvula de descarga (WC suite)", "un", 280, 720.00, {"sinapi": "86888"}),
                ...
                ("09.011", "Detecção e alarme de incendio enderecavel (Addressable fire detection)", "m2", 46500, 22.00, {"nbr": "NBR 17240"}),
                ("09.012", "Pressurização de escadas de seguranca (Stair pressurisation)", "un", 4, 145000.00, {"nbr": "NBR 9077"}),
            ],
        ),
        ...
        (
            ...
            [
                ...
                ("10.006", "Luminária LED de embutir com sensor de presenca (LED luminaire + sensor)", "un", 8600, 185.00, {"sinapi": "97593"}),
                ...
                ("10.012", "Automação predial BMS e gestao de energia (Building mgmt system)", "vb", 1, 980000.00, {"nbr": "NBR 16280"}),
                ("10.013", "Ponto de recarga de veiculo elétrico nos subsolos (EV charging point)", "un", 80, 7200.00, {"nbr": "NBR 17019"}),
        ...
        (
            ...
            {"nbr": "NBR 16401"},
            [
                ("11.001", "Central de água gelada com chiller centrifugo 800TR (Centrifugal chiller)", "un", 2, 1850000.00, {"nbr": "NBR 16401"}),
                ...
                ("11.006", "Ventilação mecanica e exaustao dos subsolos (Garage ventilation/CO)", "vb", 1, 685000.00, {"nbr": "NBR 16401"}),
        ...
        (
            "12",
            "Servicos Complementares e Áreas Externas (Complementary / external works)",
            {"sinapi": "COMPLEMENTAR"},
            [
                ("12.001", "Pintura latex acrílica interna 2 demaos (Internal acrylic paint)", "m2", 95000, 19.50, {"sinapi": "88489"}),
                ("12.002", "Massa corrida PVA em paredes internas (Internal filler)", "m2", 72000, 15.50, {"sinapi": "88485"}),
                ("12.003", "Pintura epoxi de piso e demarcação nos subsolos (Epoxy garage paint)", "m2", 38000, 36.00, {"sinapi": "EPOXI"}),
    ...
    project_metadata={
        ...
        "permit_note": (
            "Licenca de obras pela Prefeitura do Rio de Janeiro; aprovação do "
    ...
    tender_packages=[
        (
            ...
            "Movimento de terra, contenção, estacas, blocos, concreto armado, protensao e formas",
            "evaluating",
            [
                ("Construtora Belmiro Varandes (Varonel)", "licitação@varonel.example", 0.98),
                ("Andravel Costeira Engenharia", "obras@andravel.example", 1.03),
        ...
        (
            "Instalações Hidráulicas, Elétricas e Incendio (MEP)",
            "Instalações hidrossanitárias, elétricas, SPDA, telecom, BMS e incendio",
            "evaluating",
            [
    ...
    budget_boq_name="Orcamento Sintetico Corporativo - Padrão SINAPI",
